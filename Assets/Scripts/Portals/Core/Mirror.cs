...
public class Mirror : MonoBehaviour {
    ...
    void HandleTravellers () {
        ...
        for (int i = 0; i < trackedTravellers.Count; i++) {
            ...
            var m = transform.localToWorldMatrix * transform.worldToLocalMatrix * travellerT.localToWorldMatrix;
            ...
            if (portalSide != portalSideOld) {
                ...
                traveller.Teleport (transform, transform, m.GetColumn (3), m.rotation);
    ...
    public void Render () {
        ...
        for (int i = 0; i < recursionLimit; i++) {
            if (i > 0) {
                ...
                if (!CameraUtility.BoundsOverlap (screenMeshFilter, screenMeshFilter, portalCam)) {
                    //break;
                }
            }
    ...
    void HandleClipping () {
        ...
        float screenThickness = ProtectScreenFromClipping (portalCam.transform.position);
        ...
        foreach (var linkedTraveller in trackedTravellers) {
            var travellerPos = linkedTraveller.graphicsObject.transform.position;
            var clonePos = linkedTraveller.graphicsClone.transform.position;
            // Handle clone of linked portal coming through this portal:
            bool cloneOnSameSideAsCam = SideOfPortal (travellerPos) != SideOfPortal (portalCamPos);
    ...
    void UpdateSliceParams (PortalTraveller traveller) {
        ...
        Vector3 cloneSliceNormal = transform.forward * side;
