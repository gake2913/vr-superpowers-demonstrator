    ...
    public class Portal : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            foreach (Camera.StereoscopicEye eye in portalInfo.Keys)
            {
                ...
                portalInfo[eye].viewTexture = new RenderTexture(portalInfo[eye].eye.GetComponent<Camera>().scaledPixelWidth, portalInfo[eye].eye.GetComponent<Camera>().scaledPixelHeight, 24);
